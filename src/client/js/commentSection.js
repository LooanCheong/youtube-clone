...
const addComment = (text, id, owner) => {
  ...
  avatarBox.className = "video__comment-user-avatar";
  ...
  a.appendChild(img);
  avatarBox.appendChild(a);
  const commentBox = document.createElement("div");
  commentBox.className = "video__comment-box";
  const commentBoxOwner = document.createElement("div");
  commentBoxOwner.className = "video__comment-owner-info";
  const aa = document.createElement("a");
  aa.href = `/users/${owner._id}`;
  const usernameSpan = document.createElement("span");
  usernameSpan.innerText = owner.username;
  aa.appendChild(usernameSpan);
  commentBoxOwner.appendChild(aa);
  const timeSpan = document.createElement("span");
  timeSpan.className = "video__comment-createdAt";
  timeSpan.innerText = "방금 전";
  commentBoxOwner.appendChild(timeSpan);
  commentBox.appendChild(commentBoxOwner);
  const textBox = document.createElement("div");
  textBox.className = "video__comment-text";
